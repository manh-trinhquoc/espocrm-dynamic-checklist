...
```
vendor/bin/phpunit tests/unit/Espo/Modules/DynamicChecklist
```
...
```
vendor/bin/phpunit tests/integration/Espo/Modules/DynamicChecklist
```
...
* `site/custom/`
* `site/client/custom/`
* `site/tests/unit/Espo/Modules/DynamicChecklist`
* `site/tests/integration/Espo/Modules/DynamicChecklist`
...
2. Set *bundled* and *jsTranspiled* to true in `src/files/custom/Espo/Modules/DynamicChecklist/Resources/module.json`.
3. Add `src/files/custom/Espo/Modules/DynamicChecklist/Resources/metadata/app/client.json`
    ```json
    {
        "scriptList": [
            "__APPEND__",
            "client/custom/modules/dynamic-checklist/lib/init.js"
        ]
    }
    ```
