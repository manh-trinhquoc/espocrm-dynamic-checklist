	...
	{{#if allowCustomOptions}}
		<div class="input-group addItem">
			...
			<span class="input-group-btn">
				<button data-action="addItem" class="btn btn-default btn-icon" type="button" tabindex="-1" title="{{translate 'Add Item'}}">
		...
		<div class="input-group updateItem" style="display:none;">
			...
			<span class="input-group-btn">
				<button data-action="updateItem" class="btn btn-default btn-icon" type="button" tabindex="-1" title="{{translate 'Update Item'}}">
